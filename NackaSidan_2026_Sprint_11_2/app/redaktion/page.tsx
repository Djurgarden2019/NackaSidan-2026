    ...
    <main>
      <div className="shell">
        <section className="editorial-command-hero">
          <div>
            <div className="kicker">Nacka Studio · Sprint 11.2</div>
        ...
        <section className="editorial-live-callout">
          <div><div className="kicker">Nacka Intelligence · Live</div><h2>Riktiga källor är nu anslutna</h2><p>RSS-flöden hämtas när webbplatsen byggs och kategorifiltret körs i webbläsaren. Inkommande poster markeras som ej verifierade tills redaktionen har granskat dem.</p></div>
