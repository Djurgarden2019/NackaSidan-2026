...
export default function WeekendPage() {
  ...
  return <main><div className="shell weekend-desk">
    <header className="weekend-head"><div><div className="kicker">Uppdaterad 4 september 2026</div><h1>Helg</h1><p className="lead">Längre läsning för en långsammare stund. Reportage, psykologi, filosofi, mat, klimat, vetenskap och sport med analys och öppna källor.</p><nav aria-label="Helgavdelningar" style={{display:'flex',flexWrap:'wrap',gap:12,marginTop:22}}><a href="#psykologi-filosofi">Psykologi & filosofi</a><a href="#mat">Mat, vin & krogar</a><a href="#klimat">Klimat</a></nav></div><div className="weekend-date"><span>Fredag</span><strong>4</strong><span>september 2026</span></div></header>
