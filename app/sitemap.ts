...
export default function sitemap():MetadataRoute.Sitemap{
 const routes=['/','/daily','/senaste','/stockholm','/sverige','/varlden','/ekonomi','/kultur','/kulturdebatt','/vetenskap','/sport','/tema/ai','/kunskap','/sok','/om','/forfattare/redaktionen','/principer','/rattelser','/integritet','/tillganglighet','/kontakt','/artikel/veckans-analys','/artikel/veckan-pa-tio-minuter'];
