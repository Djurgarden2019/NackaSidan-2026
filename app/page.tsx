...
export default async function Home(){
 ...
 return <main><div className="shell world-front">
  ...
  <section className="world-lead" aria-labelledby="world-lead-title"><div className="world-lead-media"><span className="top-six-number">01</span><img src={lead.image} alt="Nyhetsbild från området kring Hormuzsundet"/><span>{lead.imageCredit}</span></div><article><div className="kicker">Huvudnyhet · {lead.section}</div><h2 id="world-lead-title"><a href={lead.href} target="_blank" rel="noreferrer">{lead.title}</a></h2><p className="lead">{lead.summary}</p><div className="world-lead-actions"><a className="button" href={lead.href} target="_blank" rel="noreferrer">Läs hela nyheten</a><Link className="text-link" href="/varlden">NackaSidans analys →</Link></div></article></section>
