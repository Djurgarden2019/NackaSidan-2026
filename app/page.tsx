...
export default async function Home(){
 ...
 return <main><div className="shell world-front">
  <section className="world-front-heading"><div><div className="breaking-line"><span>Senaste nytt</span> Uppdaterad {updatedToday}</div><p className="lead">Startsidan visar endast verifierade nyheter som har publicerats under de senaste 24 timmarna.</p></div><Link className="text-link" href="/senaste">Öppna Senaste nytt →</Link></section>
