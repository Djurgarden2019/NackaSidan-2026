...
export default async function Page({params}:{params:Promise<{slug:string}>}){
 ...
 return <main><article className="shell article-page">
  <div className="kicker">{article.section} · Uppdaterad {new Intl.DateTimeFormat('sv-SE',{day:'numeric',month:'long',year:'numeric',timeZone:'Europe/Stockholm'}).format(new Date())}</div>
