...
export default function WorldPage(){return <main><div className="shell">
 <div className="page-hero"><div className="kicker">Världen · Uppdaterad 4 september 2026</div><h1>Världen hänger ihop mer än rubrikerna visar</h1><p>Aktuella internationella nyheter med längre analys av drivkrafter, konsekvenser, osäkerheter och betydelsen för Sverige.</p></div>
