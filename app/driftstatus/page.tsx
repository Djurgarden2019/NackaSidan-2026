...
export default async function DriftstatusPage() {
  ...
  return <main style={{ maxWidth:960, margin:'0 auto', padding:'72px 28px 100px' }}>
    <p style={{ color:'#a61919', fontWeight:800, letterSpacing:2, fontSize:13 }}>MAIN 353 · DRIFTSTATUS</p>
    <h1 style={{ fontFamily:'Georgia,serif', fontSize:'clamp(48px,7vw,82px)', lineHeight:.98, margin:'12px 0 18px' }}>Nyhetsradarns status</h1>
    <p style={{ fontFamily:'Georgia,serif', fontSize:20, lineHeight:1.45, maxWidth:760 }}>Visuell kontroll av live-data, release-verifiering, statusregler, källhälsa och den deployment som faktiskt kör.</p>
    ...
    <section aria-label="Release-verifiering" style={{marginTop:24,padding:'20px 22px',border:`3px solid ${releaseStatus==='VERIFIED'?'#235c2b':releaseStatus==='BEVAKA'?'#8a6400':'#a61919'}`,background:releaseStatus==='VERIFIED'?'#eef4ec':releaseStatus==='BEVAKA'?'#fff4d8':'#f7e7e7'}}>
