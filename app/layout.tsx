...
export const metadata: Metadata = {
  ...
  title: {
    default: 'NackaSidan 2026 | Nyheter, analys och perspektiv',
    template: '%s | NackaSidan 2026',
  },
  ...
  openGraph: {
    type: 'website',
    locale: 'sv_SE',
    siteName: 'NackaSidan 2026',
    title: 'NackaSidan 2026 | Förstå världen. Inte bara nyheterna.',
    description: 'Nyheter, analys och perspektiv från Stockholm och Sverige till världen.',
    url: '/',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'NackaSidan 2026',
    description: 'Förstå världen. Inte bara nyheterna.',
  },
