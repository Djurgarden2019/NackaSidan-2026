...
export default function LiveRadarBrowser(){
 ...
 return <>
  ...
  <section className="s14-control">
    <div><div className="kicker">Sprint 14 · Autopublicering – pilot</div><h2>Automatisk publiceringsmotor</h2><p>Gröna signaler kan publiceras automatiskt i pilotens lokala publiceringsarkiv. Gula stannar för mer källstöd. Röda stannar alltid för mänsklig kontroll.</p></div>
