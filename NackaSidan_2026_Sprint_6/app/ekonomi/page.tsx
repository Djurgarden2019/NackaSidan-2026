    ...
    <main>
      <div className="shell">
        <div className="page-hero">
          <div className="kicker">Ekonomi</div>
          <h1>Räntor, priser och jobb avgör hushållens höst</h1>
          <p>Ekonomin förbättras, men utvecklingen är ojämn. Här samlar vi de viktigaste sambanden och konsekvenserna.</p>
        </div>
